...
**Supporting sources**:
- `paper/planning/global_outline.md`, `page_budget.md`, `claim_evidence_map.md`, and `argument_blueprint.md` from `academic-paper`, if present.
...
4. Build a section map.
   - If an `academic-paper` global outline or argument blueprint exists, use it for whole-paper order and page allocation.
   - Treat that outline as organizational guidance only; the solution package remains the factual authority.
