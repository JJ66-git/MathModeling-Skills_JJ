...
For mathematical-modeling papers, `modeling-figure-orchestrator` is the controlling handoff. This
agent may draft a chart specification or renderer, but it must follow the shared four-family
coverage check (model principle, key comparison, sensitivity, decision scheme), merge same-theme
evidence, preserve source traceability, and pass final-width visual QA before paper insertion.
...
|---------|-------|--------|-----|
| Single column | 3.3 in (84 mm) / full text width | >=5 cm | Effective resolution recorded; official rule wins, otherwise about 240 dpi for raster |
| 1.5 column | 5.0 in (127 mm) | >=5 cm | Effective resolution recorded; official rule wins, otherwise about 240 dpi for raster |
| Double column / full page | 6.9 in (175 mm) / full text block | >=5 cm | Effective resolution recorded; official rule wins, otherwise about 240 dpi for raster |
...
| 7 | Resolution adequate | Vector preferred; raster pixel dimensions/effective resolution recorded and sharp at target width | Re-export or enlarge figure |
